...
// Busca a referência do elemento com o ID "greeting"
const greetingElement = document.getElementById("greeting");

// Insere a hora atual do sistema
const currentHour = new Date().getHours();

// Escolhe a saudação com base na hora atualizada
...
//observa a mudança dos elementos
